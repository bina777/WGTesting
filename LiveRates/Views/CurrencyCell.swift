...
class CurrencyCell: UITableViewCell {
    ...
    private let currencyCodeLabel = ViewCreationHelper.createLabel()
    private let currencyLabel = ViewCreationHelper.createLabel(font: Constants.codeTextFont, textColor: .lightGray)
...
//        selectedBackgroundView = nil
    ...
    private func setupConstraints() {
        ...
        currencyCodeLabel.pinLeadingEdge(to: self, withOffset: Constants.codeLabelLeadingOffset)
